...
@Component({
    selector: 'symbiota2-field-map-select',
    templateUrl: './field-map-select.component.html',
    styleUrls: ['./field-map-select.component.scss'],
    providers: [{
        provide: NG_VALUE_ACCESSOR,
        multi: true,
        useExisting: forwardRef(() => FieldMapSelectComponent)
    }]
})
export class FieldMapSelectComponent implements ControlValueAccessor, OnInit {
